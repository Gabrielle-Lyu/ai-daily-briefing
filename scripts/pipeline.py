...
def _dry_run_summary(article: dict, audience_id: str) -> dict:
    return {
        ...
        "summary":         (
            ...
            "In production, Claude generates a personalised 2-3 sentence summary "
            "tailored to this executive's role and priorities."
        ),
        "oci_implication": (
            "OCI implication placeholder: Claude would generate a concrete, "
...
def _dry_run_exec_summary(top_articles: list[dict], audience_id: str) -> dict:
    ...
    return {
        ...
        "oci_implication_of_day": (
            ...
            "Claude would synthesise today's top signals into a concrete strategic "
